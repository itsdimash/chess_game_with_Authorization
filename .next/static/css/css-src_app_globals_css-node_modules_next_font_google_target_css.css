...
.bg-\[\#b58863\] {
  --tw-bg-opacity: 1;
  background-color: rgb(181 136 99 / var(--tw-bg-opacity, 1));
}
.bg-\[\#f0d9b5\] {
  --tw-bg-opacity: 1;
  background-color: rgb(240 217 181 / var(--tw-bg-opacity, 1));
}
.bg-amber-400\/10 {
...
/* Map CSS variables to Tailwind custom classes */
.bg-background { background-color: var(--background); }
.bg-surface { background-color: var(--surface); }
.bg-surface2 { background-color: var(--surface2); }
.border-border { border-color: var(--border); }
.border-border2 { border-color: var(--border2); }
